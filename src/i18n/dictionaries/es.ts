...
const es: Dictionary = {
  ...
  hero: {
    ...
    title: "Zanzibar es tu lugar feliz",
  ...
  discover: {
    ...
    description:
      "Encuentra el Zanzibar Lounge más cercano a ti.",
  },

  footer: {
    tagline: "Zanzibar es tu lugar feliz",
    follow: "Seguir",
  ...
  reviews: {
    ...
    lead: "Lee lo que nuestros clientes opinan sobre su experiencia en Zanzibar Lounge.",
