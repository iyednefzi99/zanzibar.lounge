...
const de: Dictionary = {
  ...
  hero: {
    ...
    title: "Zanzibar ist Ihr glücklicher Ort",
  ...
  footer: {
    tagline: "Zanzibar ist Ihr glücklicher Ort",
    follow: "Folgen",
  ...
  reviews: {
    ...
    lead: "Lesen Sie, was unsere Gäste über ihren Besuch im Zanzibar Lounge denken.",
